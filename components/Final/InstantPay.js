...
const InstantPay = props => {
  ...
  // const [debitCardNumber, setDebitCardNumber] = useState(false);
  // const [debitCardMonth, setDebitCardMonth] = useState(false);
  // const [debitCardYear, setDebitCardYear] = useState(false);
  // const [debitCardCvc, setDebitCardCvc] = useState(false);
