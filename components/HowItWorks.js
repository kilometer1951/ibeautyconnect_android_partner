    ...
    <View style={styles.screen}>
      ...
      <View style={{padding: 10}}>
        ...
        <Text
          ...
          iBeautyConnect takes no subscription fee, We get paid when you get
          paid, no business for you means no business for us. We take twenty
          percent from every transaction between you and your client on the day
          of your appointment.
        </Text>
        <Text
          style={{
